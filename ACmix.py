...
# ### att
        ...
        #print("q_att.shape: ", q_att.shape)
        #print("k_att.shape: ", k_att.shape)
        #print("v_att.shape: ", v_att.shape)
        ...
        #print("unfold_k.shape: ", unfold_k.shape)
...
if __name__ == "__main__":
    ...
    model = ACmix(in_planes=3, out_planes=64).to(device)
    input_tensor = torch.randn(4, 3, 128,256).to(device)
    ...
    print("Elapsed time:", elapsed_time)  # 打印执行时间
    print(output.size())